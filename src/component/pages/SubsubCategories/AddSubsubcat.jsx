...
export default function AddSubsubcat() {
    ...
    return (
        ...
        <Breadcrumb fst_para={<><FaBarsStaggered className='text-blue-500' /> Sub-Category</>} fst_path="/Parent/SubsubCategories/add" snd_para="Add Sub Sub-Category" />
                ...
                <div className='m-5'>
                    ...
                    <div className='grid grid-cols-[30%_auto] gap-5'>
                        ...
                        <div>
                            ...
                            <select name="sub_cate_name" id="sub_cate_name" className='w-full py-2 ps-2  rounded-md border-1 border-stone-400'>
                                <option value=""> Select Category </option>
                                <option value=""> Men </option>
                                <option value=""> Women </option>
                                <option value=""> Shoe </option>
                            ...
                            <input type="text" id='sub_sub_cate_name' placeholder='Enter Sub Sub-Category Name...' className='w-full py-2 ps-2  rounded-md border-1 border-stone-400' />

                            <label htmlFor="sub_sub_cate_order" className='block my-2 font-bold'>
                                Sub Sub-Category Order
                            </label>
                            <input type="text" id='sub_sub_cate_order' placeholder='Enter Sub Sub-Category Order...' className='w-full py-2 ps-2  rounded-md border-1 border-stone-400' />
                        </div>
                    </div>
