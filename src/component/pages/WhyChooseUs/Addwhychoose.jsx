...
export default function Addwhychoose() {
  ...
  return (
    <>
    <Breadcrumb fst_para={<><FaHistory className='text-blue-500' /> Why Choose Us</>} fst_path="/WhyChooseUs/add" snd_para="Add" />
    ...
    <div className='max-w-[1320px] mx-auto gap-3 mb-50 mt-10 border-1'>
                ...
                <div className='m-5'>
                    ...
                    <div className='grid grid-cols-[30%_auto] gap-5'>
                        ...
                        <div>
                            <label htmlFor="wcu_title" className='block my-2 font-bold'>
                                Title
                            </label>
                            <input type="text" id='wcu_title' placeholder='Enter Title...' className='w-full py-2 ps-2 rounded-md border-1 border-stone-400' />

                            <label htmlFor="wcu_order" className='block my-2 font-bold'>
                                Order
                            </label>
                            <input type="text" id='wcu_order' placeholder='Enter Order...' className='w-full py-2 ps-2 rounded-md border-1 border-stone-400' />

                            <label htmlFor="wcu_descp" className='block my-2 font-bold'>
                                Description
                            </label>
                            <textarea name="wcu_descp" id="wcu_descp" placeholder='Enter Description...' className='w-full py-2 ps-2 rounded-md border-1 border-stone-400' ></textarea>
