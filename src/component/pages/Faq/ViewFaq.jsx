...
export default function ViewFaq() {
  ...
  return (
    <>
    <Breadcrumb fst_para={<><RiQuestionnaireFill className='text-blue-500' /> Faqs</>} fst_path="/faq/view" snd_para="View" />
                            ...
                            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <th scope="row" className="px-6 py-4 font-medium text-gray-900 w-[300px] dark:text-white">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, eaque!
                                        </th>
                                        <td className="px-6 py-4">
                                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium beatae omnis, fugiat inventore ipsa magni veniam modi cumque, commodi delectus molestias suscipit impedit nobis? Aliquam provident similique, quia, sequi laboriosam optio inventore cupiditate et tenetur voluptates error officiis mollitia eius!
                                        </td>
                                        <td className="px-6 py-4">
                                            1
                                        </td>
